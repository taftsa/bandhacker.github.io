...
$(document).ready(function() {
	$('#topMenu').append('<div id="info"><span id="versionNumber">Version 1.4.3c</span><br />&copy; ' + copyYear + ' Seth Taft<br /><span id="emailLink">optimal.efficient@gmail.com</span></div>');
